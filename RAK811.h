...
class RAK811
{
 ...
 /*
  * Set the activation mode to join the network.
 ...
 */
 ...
 /*
  * Another function to send data but with included conversion from bytes to hex string
  */
  ...
  */
  String sendRawCommand(String command, int waitTime = 3500);
